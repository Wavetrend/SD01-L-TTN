...
describe('tagoAdapter', () => {
    ...
    test('Decodes Standard Report with all sensors', () => {
        const payload = {
            type: 3,
            version: 1,
            sequence: 0,
    ...
    test('Decodes Standard Report with out of range sensor 1', () => {
        const payload = {
            type: 3,
            version: 1,
            sequence: 0,
    ...
    test('Decodes Standard Report with out of range sensor 2', () => {
        const payload = {
            type: 3,
            version: 1,
            sequence: 0,
    ...
    test('Decodes Standard Report with out of range sensor 3', () => {
        const payload = {
            type: 3,
            version: 1,
            sequence: 0,
